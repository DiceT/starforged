...
export class StarforgedDashboardSheet extends ActorSheet {
    ...
    /** @override */
    get template() {
        return "systems/starforged/templates/actor/dashboard-sheet.hbs";
    }
    ...
    async _onRecordStats(event) {
        ...
        console.log(this.object.data.data.statistics.enabled)
    }
