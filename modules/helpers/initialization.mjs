export async function initializeFolders() {
    ...
    folderList.push("= Factions =");
    folderList.push("[ Factions - Legacies ]")
    folderList.push("[ Factions - Affiliations ]")
    folderList.push("[ Factions - Identities ]")
...
export async function initializeRollTables() {
    ...
    tables.push( {table: "Factions - Affiliation", folder: "[ Factions - Affiliations ]"} );
    tables.push( {table: "Factions - Identity", folder: "[ Factions - Identities ]"} );
    tables.push( {table: "Factions - Legacy", folder: "[ Factions - Legacies ]"} );
    tables.push( {table: "Factions - Dominion", folder: "= Factions ="} );
    tables.push( {table: "Factions - Fringe Group", folder: "= Factions ="} );
    tables.push( {table: "Factions - Guild", folder: "= Factions ="} );
    tables.push( {table: "Factions - Influence", folder: "= Factions ="} );
    tables.push( {table: "Factions - Leadership", folder: "= Factions ="} );
    tables.push( {table: "Factions - Name Template", folder: "= Factions ="} );
    tables.push( {table: "Factions - Projects", folder: "= Factions ="} );
    tables.push( {table: "Factions - Quirks", folder: "= Factions ="} );
    tables.push( {table: "Factions - Relationships", folder: "= Factions ="} );
    tables.push( {table: "Factions - Rumors", folder: "= Factions ="} );
    tables.push( {table: "Factions - Type", folder: "= Factions ="} );
